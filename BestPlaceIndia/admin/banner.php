                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <button onclick="onclearform()" type="button" class="btn btn-primary pull-right"
                                        data-toggle="modal"
                                        data-target=".bs-example-modal-lg">Add  Add Banner
                                </button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="api.php" method="post" id="addvtypeform" data-parsley-validate
                        ...
                        <input type="hidden" name="action" id="actionId" value="addbanner"/>
...
<script>
    ...
    function ondelete(id) {
        ...
        if (result) {
            ...
            var formData = {action: "deletebanner", id: id};
    ...
    function onEdit(id) {
        ...
        $("#mg").show();
        $.getJSON("api.php?action=getbanner&id=" + id, function (data) {
